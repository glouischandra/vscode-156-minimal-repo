...
class WebPanel {
  ...
  private _getHtmlForWebview() {
    ...
    const imagePath = path.join(appDistPath, 'assets/logo.png');
    ...
    indexHtml = indexHtml.replace(/replacemepls/g, imageUri.toString());
    indexHtml = indexHtml.replace(/replacewithbasepath/g, String(baseUri));
